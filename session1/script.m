...
g2Title = "G2: ACK Request Code: " + ack + "NACK Request Code: " + nack + newline + ...
    "Echo Packet experiment started: 2021-03-26 at 20:47:50 EET" + newline + ...
    "Echo Packet experiment ended: 2021-03-26 at 20:51:50 EET.";
title(g2Title);
ylabel("Response time (in milliseconds)");
xlabel("Packet");
saveas(G2,"G2.jpg");
...
g3Title = "Distribution estimation." + newline + "G3: ACK Request Code: " + ack + "NACK Request Code: " + nack + ...
    newline + "Starting Automatic Repeat experiment: 2021-03-26 at 20:52:27 EET" + newline + ...
